    ...
    <main class="messages-wrap" ref="messagesRef">
      ...
      <div v-if="messages.length === 0" class="welcome">
        ...
        <div class="quick-questions">
          <button v-for="q in quickQuestions" :key="q" @click="handleQuickQuestion(q)">
            {{ q }}
          </button>
        </div>
      </div>
    ...
    <footer class="input-area">
      <div class="input-wrap">
        ...
        >
          ...
          <span v-else class="dot-loading"> <i /><i /><i /> </span>
        </button>
      </div>
    </footer>
  </div>
...
const quickQuestions = ['我的订单在哪里？', '如何申请退款？', '物流多久到？', '如何联系客服？']
...
.message-row.user .avatar-sm {
  background: #2563eb;
  color: #fff;
}
.message-row.assistant .avatar-sm {
  background: #f1f5f9;
  color: #475569;
}
